    ...
    <div id="app">
        ...
        <header class="bg-blue-600">
            <nav class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8" aria-label="Top">
                <div class="flex w-full items-center justify-between border-b border-blue-500 py-6 lg:border-none">
                    <div class="flex items-center">
                        ...
                        <div class="ml-10 hidden space-x-8 lg:block">
                            <a href="{{ route('blog.home') }}"
                                class="text-base font-medium text-white hover:text-blue-50">Home</a>

                            <a href="{{ route('blog.show') }}"
                                class="text-base font-medium text-white hover:text-blue-50">Blog</a>

                            <a href="{{ route('dashboard.create') }}"
                                class="text-base font-medium text-white hover:text-blue-50">Write For
                                Us</a>
                    ...
                    <div class="ml-10 space-x-4">
                        @guest
                            @if (Route::has('login'))
                                <a class="inline-block rounded-md border border-transparent bg-blue-500 py-2 px-4 text-base font-medium text-white hover:bg-opacity-75"
                                    href="{{ route('login') }}">{{ __('Login') }}</a>
                            @endif

                            @if (Route::has('register'))
                                <a class="inline-block rounded-md border border-transparent bg-white py-2 px-4 text-base font-medium text-blue-600 hover:bg-blue-50"
                            ...
                            <div x-data="{ open: false }" class="relative inline-block text-left">
                                <div>
                                    <button type="button"
                                        ...
                                        id="menu-button" x-on:click="open = !open">
                                        {{ Auth::user()->name }}
                ...
                <div class="flex flex-wrap justify-center space-x-6 py-4 lg:hidden">
                    ...
                    <a href="{{ route('dashboard.create') }}"
                        class="text-base font-medium text-white hover:text-blue-50">Write For Us</a>
